...
//                }
        ...
        Log.d("post data", "post  = " + getIntent().getExtras().getString("postData"));
        
        webView.postUrl(getIntent().getExtras().getString("url"), getIntent().getExtras().getString("postData").getBytes());
    }
